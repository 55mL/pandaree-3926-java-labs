 ...
 * IPadAir [color=Rose Gold, price=19900.0, storage=64.0, chip=Apple M2]
 * IPadAir [color=Silver, price=24900.0, storage=256.0, chip=Apple M2]  
 * 
...
public class SortMobileDevicesByPrice implements Comparator<MobileDevice> {
    ...
    public int compare(MobileDevice device, MobileDevice devices ){
        return  Double.compare(device.price, devices.price);
    }
    // Main method
